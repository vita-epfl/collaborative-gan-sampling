...
flags.DEFINE_boolean("save_model", False, "True for saving model, False for nothing [False]")
flags.DEFINE_boolean("crop", False, "True for training, False for testing [False]")
flags.DEFINE_boolean("visualize", True, "True for visualizing, False for nothing [False]")
flags.DEFINE_integer("generate_test_images", 100, "Number of images to generate during test. [100]")
flags.DEFINE_string("refiner_name", "default", "teacher options: default | scalized | mcts | rollout | gpurollout")
...
flags.DEFINE_integer("load_epoch", 1, "Epoch to load from for refinement")
flags.DEFINE_string("load_model_dir", "checkpoints/mnist/epoch_5_teacher_default_rollout_method_momentum_rollout_steps_100_rollout_rate_50.00000/", "directory to load model from")
...
flags.DEFINE_integer("rollout_steps", 50, "Roll Out Steps. [100]")
flags.DEFINE_float("rollout_rate", 50, "Roll Out Rate [50]")
...
flags.DEFINE_integer("collab_layer", 4, 
  ...
  with tf.Session(config=run_config) as sess:
    ...
    if FLAGS.train:
      ...
      for i in range(FLAGS.num_it):
        inc_score, fid_score = nsgan.train(FLAGS)
      ...
      print("Avg FID Score")
      print(ave_fid_score)
      nsgan.save_scores(ave_inc_score, ave_fid_score, config=FLAGS, num_it=FLAGS.num_it)
    ...
    OPTION = 0
    visualize(sess, nsgan, FLAGS, OPTION)
