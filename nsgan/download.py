...
parser.add_argument('datasets', metavar='N', type=str, nargs='+', choices=['celebA', 'lsun', 'mnist', 'cifar'],
           help='name of dataset to download [celebA, lsun, mnist, cifar]')
...
def download_cifar10(dirpath):
  ...
  if os.path.exists(data_dir):
    ...
    os.mkdir(data_dir)
  url_base = 'http://www.cs.toronto.edu/~kriz/'
...
if __name__ == '__main__':
  ...
  if 'mnist' in args.datasets:
    download_mnist('./data')
  if any(name in args.datasets for name in ['cifar', 'cifar10']):
