...
def get_inception_scores(images, num_batches=10):
...
def get_frechet_inception_distance(real_images, generated_images, num_batches=1):
  ...
  # num_batches = images.shape[0] // num_inception_images
