...
flags.DEFINE_string("dataset", "celebA", "The name of dataset [celebA, mnist, cifar10, lsun]")
...
flags.DEFINE_integer("epoch", 100, "Epoch to train G and D [20]/ Epochs to refine D [5]")
flags.DEFINE_integer("load_epoch", 0, "Epoch to load from for refinement")
flags.DEFINE_string("load_model_dir", "dc_checkpoints/celebA/epoch_15_refiner_default_rollout_method_momentum_rollout_steps_100_rollout_rate_50.00000/celebA_64_64_64/", "directory to load model from")
...
flags.DEFINE_float("rollout_rate", 5, "Roll Out Rate [50]")
...
flags.DEFINE_integer("collab_layer", 5, "Layer to collaborate. [5]")
...
# dc_checkpoints/mnist/epoch_12_refiner_gpurollout_rollout_method_sgd_rollout_steps_1_rollout_rate_1.00000/mnist_64_28_28/
# dc_checkpoints/celebA/epoch_17_refiner_gpurollout_rollout_method_sgd_rollout_steps_1_rollout_rate_1.00000/celebA_64_64_64/
